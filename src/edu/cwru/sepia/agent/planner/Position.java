...
public class Position {
    ...
    /**
     * Returns the adjacent position nearest to the given position
     * @param position The position for reference
     * @return The adjacent position in the direction of the given position
     */
    public Position getNearestAdjacentPosition(Position position) {
    	int xDiff = x - position.x;
    	int yDiff = y - position.y;
    ...
    // Returns a string that can be used as a quick id key for this position
