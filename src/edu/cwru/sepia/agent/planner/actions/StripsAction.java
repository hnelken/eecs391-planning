...
public interface StripsAction {
    ...
    /**
     * Returns the cost of the action, based on the state it will be applied to
     * @param state The state the action will be applied to
     * @return The cost of taking the action from the given state
     */
    public double getCost(GameState state);
    
    /**
     * Returns the ID of the unit performing the action
     * @return the ID of the performing unit
     */
